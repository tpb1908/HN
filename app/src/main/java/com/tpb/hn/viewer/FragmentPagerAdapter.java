...
public class FragmentPagerAdapter extends android.support.v4.app.FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch(pages.get(position)) {
            case COMMENTS:
                page = CommentFragment.getInstance(mCommentId);
                fragments[position] = page;
                break;
            case BROWSER:
                page = ContentFragment.newInstance(PageType.BROWSER);
                fragments[position] = page;
                break;
            case TEXT_READER:
                page = ContentFragment.newInstance(PageType.TEXT_READER);
                fragments[position] = page;
                break;
            case AMP_READER:
                page = ContentFragment.newInstance(PageType.AMP_READER);
                fragments[position] = page;
                break;
            case SKIMMER:
                page = new SkimmerFragment();
                fragments[position] = page;
                break;
        }
    ...
    public enum PageType {
        ...
        TEXT_READER, //ContentFragment fragment
        AMP_READER, //ContentFragment fragment
        SKIMMER; //SkimmerFragment fragment
