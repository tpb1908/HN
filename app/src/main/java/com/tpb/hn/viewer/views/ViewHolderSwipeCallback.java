...
public abstract class ViewHolderSwipeCallback extends ItemTouchHelper.SimpleCallback {
    ...
    public ViewHolderSwipeCallback(int dragDirs, int swipeDirs) {
    ...
    public ViewHolderSwipeCallback(int dragDirs, int swipeDirs, String left, String right) {
        super(dragDirs, swipeDirs);
        mPaint = new Paint();
        this.lt = left;
        this.rt = right;
